...
const EXIT_AT = 4300 // sortie → transition vers la page principale

/**
 * ClockIntro — écran d'entrée VWION, en un seul temps :
 * l'horloge de bienvenue (les aiguilles rejoignent l'heure réelle) + le message
 * « Bienvenue chez VWION », puis une transition en fondu/zoom qui révèle le site.
 */
export default function ClockIntro() {
  ...
  useEffect(() => {
    ...
    const t3 = setTimeout(() => setVisible(false), EXIT_AT)
