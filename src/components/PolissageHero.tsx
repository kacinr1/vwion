...
export const SECTIONS = [
  {
    id: 'boitier',
    poster: '/hero/real-macro-poster.jpg',
    label: 'MÉCANIQUE',
    number: '01',
    title: "L'Art Invisible",
    accent: 'de la Perfection',
    desc: "Le cœur mécanique révélé — rouages, ponts et rubis. La précision d'un savoir-faire d'exception, dans le moindre détail.",
    videoUrl:
      '/hero/real-macro.mp4',
    align: 'left' as const,
  },
  {
    id: 'fond',
    poster: '/hero/real-rm-poster.jpg',
    label: 'EXCELLENCE',
    number: '02',
    title: 'Les Plus Belles',
    accent: 'Signatures',
    desc: 'Rolex, Patek Philippe, Richard Mille… les plus grandes maisons passent entre nos mains, traitées avec la même exigence absolue.',
    videoUrl:
      '/hero/real-rm.mp4',
  ...
  {
    id: 'carrure',
    poster: '/hero/real-longines-poster.jpg',
    label: 'LUMIÈRE',
    number: '03',
    title: 'Lumière',
    accent: 'Pure',
    ...
    videoUrl:
      '/hero/real-longines.mp4',
    align: 'left' as const,
  },
  {
    id: 'bracelet',
    poster: '/hero/real-eclat-poster.jpg',
    label: 'RÉVÉLATION',
    number: '04',
    title: "L'Éclat",
    accent: 'Retrouvé',
    desc: "La pièce restaurée retrouve son éclat d'origine. Chaque reflet raconte des heures de travail — le temps, sublimé.",
    videoUrl:
      '/hero/real-eclat.mp4',
    align: 'right' as const,
  },
