...
export const metadata: Metadata = {
  ...
  description,
  keywords: [
    'restauration montre luxe Genève', 'polissage montre', 'polir montre', 'polissage boîtier montre',
    'émerisage', 'avivage', 'anglage', 'meulage', 'cabronnage', 'satinage',
    'terminaison horlogère', 'finition horlogère', 'préparation avant polissage',
    'polissage miroir Rolex', 'SAV Rolex Genève', 'SAV Patek Philippe', 'restauration Patek Philippe',
    'métier manuel horloger', 'artisan horloger', 'savoir-faire horloger', 'bijouterie polissage',
  ],
